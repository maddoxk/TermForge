"""TermForge checklist component renderer."""
...
def render_checklist(
    ...
    """Render the Checklist component to layout lines.

    Args:
        spec: ChecklistSpec containing items and styles.
    ...
    for idx, item in enumerate(spec.items):
        ...
        if is_selected:
            ...
            style_token = spec.checked_style if item.checked else spec.unchecked_style
            
        # Style indicator and text
        ...
        # 3. Add trailing spaces to pad width
    ...
    # 4. Fill remaining background lines to height
